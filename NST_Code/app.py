...
# Globally override torch.load to always force CPU mappings
#orig_load = torch.load
#torch.load = lambda *args, **kwargs: orig_load(*args, **kwargs, map_location=torch.device('cpu')) if 'map_location' not in kwargs else orig_load(*args, **kwargs)
